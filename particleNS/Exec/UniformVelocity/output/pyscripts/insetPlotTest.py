...
# plt.subplots_adjust(left=0.129, bottom=0.088, right=0.936, top=0.968, wspace=0.20, hspace=0.20)
# fig = 
...
#     ax[0].plot(times/1e5, vPlot,color=colors[i],ls = '-', lw = 1, label='$L_x='+domain+'\;\mathrm{m}$')
...
#     ax[1].plot(times/1e5, freqPlot,color=colors[i],ls = '-', lw = 1)
...
#     ax[2].plot(spfreq, velocityFFT.real,color=colors[i*2])
