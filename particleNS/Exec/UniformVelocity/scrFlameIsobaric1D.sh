...
do
    for j in "${tests[@]}"
    do
	    mpirun -np 6 ./main1d.gnu.MPI.ex inputs amr.n_cell = 1024 0 0 euler = 2 viscous = 1 source = 0 particle = 2 Da = 1\
        ...
        amr.max_grid_size = 64 amr.plot_files_output = 0 amr.plot_file = detonation/plt stop_time = 0.020\
