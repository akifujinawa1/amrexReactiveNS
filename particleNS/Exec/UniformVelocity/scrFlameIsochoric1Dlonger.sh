...
cp -r output/txt/1DflameConfined/isochoric/field/ output/txt/1DflameConfined/fft512/
cp -r output/txt/1DflameConfined/isochoric/particle/ output/txt/1DflameConfined/fft512/
...
cp -r output/txt/1DflameConfined/isochoric/field/ output/txt/1DflameConfined/fft768/
cp -r output/txt/1DflameConfined/isochoric/particle/ output/txt/1DflameConfined/fft768/
...
cp -r output/txt/1DflameConfined/isochoric/field/ output/txt/1DflameConfined/fft1024/
cp -r output/txt/1DflameConfined/isochoric/particle/ output/txt/1DflameConfined/fft1024/
